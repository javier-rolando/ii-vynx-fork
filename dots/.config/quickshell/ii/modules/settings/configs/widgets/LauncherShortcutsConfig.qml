...
Item {
    ...
    readonly property var defaults: [
        ...
        { actionId: "favorite", name: Translation.tr("Toggle favorite"), keys: "Ctrl+Shift+P", icon: "star" },
        ...
        { actionId: "create", name: Translation.tr("Create from search"), keys: "Ctrl+Shift+A", icon: "add" },
