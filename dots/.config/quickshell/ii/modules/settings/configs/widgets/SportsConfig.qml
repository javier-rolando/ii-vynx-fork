...
ContentPage {
    ...
    readonly property var espnData: {
        ...
        "rugby-league": ["3"],
        "soccer": ["concacaf.gold", "uefa.euro", "conmebol.america", "fifa.friendly", "fifa.world", "fifa.wwc", "usa.1", "usa.nwsl", "mex.1", "uefa.champions_qual", "uefa.champions", "uefa.europa", "eng.1", "ita.1", "ger.1", "esp.1", "fra.1", "eng.2", "eng.league_cup", "eng.fa", "esp.copa_del_rey", "ita.coppa_italia", "ger.dfb_pokal", "fra.coupe_de_france", "mex.copa_mx", "concacaf.champions", "ned.1", "arg.1", "arg.copa", "conmebol.libertadores", "conmebol.sudamericana"],
