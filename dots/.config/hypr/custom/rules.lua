...
hl.workspace_rule({ workspace = "special:update",      ["on_created_empty"] = 'kitty --class "kitty-update" -e fish -c "upd"' })
hl.workspace_rule({ workspace = "special:install",     ["on_created_empty"] = 'kitty --class "kitty-install" -e fish -c "pkginstall"' })
hl.workspace_rule({ workspace = "special:uninstall",   ["on_created_empty"] = 'kitty --class "kitty-uninstall" -e fish -c "pkgremove"' })
hl.workspace_rule({ workspace = "special:yazi",        ["on_created_empty"] = 'kitty --class "kitty-yazi" -e fish -c "yazi"' })
hl.workspace_rule({ workspace = "special:btop",        ["on_created_empty"] = 'kitty --class "kitty-btop" -e fish -c "btop"' })
